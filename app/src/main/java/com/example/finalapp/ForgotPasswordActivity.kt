...
import com.example.finalapp.databinding.ActivityForgotPasswordBinding
        ...
        forgotBinding.buttonReset.setOnClickListener {
            ...
            auth.sendPasswordResetEmail(userEmail).addOnCompleteListener{ task ->
                ...
                if (task.isSuccessful){
                    ...
                    Toast.makeText(applicationContext, "The password reset mail is sent to your email adress",Toast.LENGTH_SHORT).show()
                    finish()
